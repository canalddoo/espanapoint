...
const FEATURED_PRODUCTS = [
  ...
  ...PRODUCTS_DATA.find((product) => product.id === featuredProduct.id)!,
  ...
  return (
    <div className="home-page-container">
      ...
      <div className="featured-hero">
        ...
        <p>
          Descubra nuestra selección exclusiva de productos más votados por
          nuestros clientes por su calidad y fiabilidad.
        </p>
      </div>
