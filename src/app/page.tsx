...
import { PRODUCTS_DATA as CATALOG_PRODUCTS } from "@/lib/products";

const LEGACY_PRODUCTS_DATA = [
  // ==========================================
  ...
  {
    id: 4,
    name: "Google Pixel 11 Pro - Smartphone Android libre - Negro volcánico, 256 GB",
    price: 1150.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 6,
    name: "Sony WH-1000XM5SA Edición Especial con estuche blando, Cancelación Activa de Ruido",
    price: 211.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 7,
    name: "Apple Watch Series 9 (GPS + Cellular, 45 MM) Caja de Aluminio Blanco Estrella",
    price: 371.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 8,
    name: "DJI Osmo Pocket 3 + Transmisor Mic Mini (Negro Obsidiana)",
    price: 401.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 9,
    name: "Sony, Consola PlayStation 5 Edición Estándar 1 TB",
    price: 481.99,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 10,
    name: "Nintendo Switch (OLED) Consola de Juegos Portátil de 17,8 cm, 64 GB",
    price: 201.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 11,
    name: "Apple MacBook Pro - Ordenador portátil con chip M5, 1 TB de almacenamiento",
    price: 2199.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 13,
    name: "SSD externo SanDisk Extreme de 1 TB (hasta 1050 MB/s)",
    price: 159.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 14,
    name: "The G-Lab Keyz Titanium Noir - Teclado gaming mecánico 65% RGB",
    price: 29.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 20,
    name: "ZIPRO Bicicleta Estática para Adulto con Resistencia Magnética",
    price: 111.0,
    category: "Deporte / Fitness",
  ...
  {
    id: 21,
    name: "PROIRON Tapis de Yoga Epais 10MM/15MM, Antidérapant",
    price: 24.99,
    category: "Deporte / Fitness",
  ...
  {
    id: 23,
    name: "MIXA - Sérum Booster de Hidratación Intensa 24H",
    price: 9.99,
  ...
  {
    id: 25,
    name: "Cepillo secador y moldeador TYMO - Secador y cepillo iónico «One-Step»",
    price: 48.0,
    category: "Belleza y cuidado personal",
  ...
  {
    id: 28,
    name: "DREAME H15 Pro CarpetFlex aspiradora inalámbrica con mopa",
    price: 361.0,
    category: "Hogar",
  ...
  {
    id: 29,
    name: "Cámara de vigilancia EZVIZ C8c 4K WiFi para exteriores de 360°",
    price: 72.0,
    category: "Hogar",
  ...
  {
    id: 30,
    name: "GASLAND GIH604BF Placa Mixta de Gas e Inducción 60 cm",
    price: 341.0,
    category: "Cocina",
  ...
  {
    id: 31,
    name: "Google Pixel 10 Pro XL – Smartphone Android libre con Gemini, triple cámara trasera",
    price: 929.0,
    category: "Dispositivos electrónicos",
  ...
  {
    id: 32,
    name: "Cosori TurboBlaze - Freidora de aire, 9 en 1, 6 cuartos de galón",
    price: 85.0,
    category: "Cocina",
  ...
  {
    id: 33,
    name: "Cámara para exteriores WiFi 360° MERCUSYS 2K, MC510",
    price: 28.0,
    category: "Hogar",
  ...
  {
    id: 34,
    name: "TP-Link Tapo - Cámara de seguridad interior de 1080P para monitor de bebé",
    price: 9.0,
    category: "Hogar",
  ...
  {
    id: 35,
    name: "Ninja Cafetera programable de 12 tazas, 2 estilos de preparación",
    price: 199.99,
    category: "Cocina",
  ...
  {
    id: 36,
    name: "Aspiradora escoba inalámbrica Roborock H60 Ultra, 210 AW",
    price: 129.0,
    category: "Hogar",
  ...
  {
    id: 37,
    name: "Bissell PowerClean FurGuard 280W Aspiradora inalámbrica",
    price: 221.99,
    category: "Hogar",
  ...
  {
    id: 38,
    name: "HORION Roku TV 40 QLED Smart FHD Televisión con Quantum Dot Color",
    price: 179.0,
    category: "Hogar",
    image: "/img/TV4K.jpg",
  },
  {
    id: 39,
    name: "Mini refrigerador retro de 3.5 pies cúbicos con congelador, azul",
    price: 79.0,
    category: "Hogar",
...
const PRODUCTS_DATA = CATALOG_PRODUCTS;
export function HomePageContent() {
  ...
  const [shuffledProducts] = useState<typeof PRODUCTS_DATA>(() => {
    const mixedProducts = [...PRODUCTS_DATA];

    for (let i = mixedProducts.length - 1; i > 0; i--) {
      const j = Math.floor(Math.random() * (i + 1));
      [mixedProducts[i], mixedProducts[j]] = [
        mixedProducts[j],
        mixedProducts[i],
      ];
    }
  ...
  // The previous useEffect for shuffling products is removed as we now initialize shuffledProducts directly.
  ...
  const filteredProducts = shuffledProducts.filter((product) => {
    ...
    const matchesCategory = targetCategory
      ? cleanProductCat === cleanTargetCat
      : true;
          ...
          <div className="features-section">
            <div className="features-container">
              ...
              <div className="feature-card">
                ...
                <p>
                  Productos 100% auténticos y seleccionados con total cuidado
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p>
                  Recoja sus artículos directamente en tienda y ahorre tiempo
                </p>
              </div>
            </div>
          </div>
